    ...
    suspend fun resetAdvanced() {
        update { s ->
            ...
            s.copy(
                ...
                tuningCents = d.tuningCents, straightMaxCents = d.straightMaxCents, vibratoMinHz = d.vibratoMinHz, vibratoMaxHz = d.vibratoMaxHz, vibratoMaxCents = d.vibratoMaxCents,
